...
class IOrderService(ABC):
    ...
    @abstractmethod
    async def get_order_details(self, order_id: UUID, user_id: UUID) -> Optional[Order]:
        """注文詳細を取得"""
        pass
...
class IKitchenService(ABC):
    ...
    async def update_kitchen_status(
        self, active_staff_count: int, notes: Optional[str], user_id: UUID
    ) -> bool:
        """キッチン状況を更新"""
        pass
