...
from repositories.domains.menu_repo import MenuItemRepository, MenuCategoryRepository
...
class MenuService:
    ...
    async def bulk_update_menu_availability(
        ...
        for menu_item_id, is_available in availability_updates.items():
            try:
                await self.toggle_menu_item_availability(menu_item_id, is_available, user_id)
